...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {        
        // some code goes here
        // return 0;
        double pageSize = (Database.getBufferPool().PAGE_SIZE * 8);
        double tupleSize = td.getSize() * 8 + 1;
        return (int) Math.floor(pageSize / tupleSize);
    }
    ...
    private int getHeaderSize() {        
        // some code goes here
        // return 0;
        return (int) Math.ceil((double)getNumTuples() / 8); //need precision!
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        RecordId rid = new RecordId(this.pid, slot);
        t.setRecordId(rid);
    }
    ...
    public boolean isSlotUsed(int i) {
        ...
        int headerNum = i / 8;
        int bitNum = i % 8;
        if (headerNum < header.length) {
            byte h = header[headerNum];
